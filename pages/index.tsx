  ...
  return (
    <>
      ...
      <div className="flex w-fit mx-auto gap-4 my-8 mb-[250px]">
        <aside className="w-[160px] h-[600px] bg-gray-100/10">
          <div id="ezoic-pub-ad-placeholder-116"> </div>
        </aside>
        <div className="w-fit space-y-10">
          <div className="w-[728px] h-[90px] bg-gray-100/10 mx-auto">
        ...
        <aside className="space-y-4">
          <div className="w-[300px] h-[250px] bg-gray-100/10">
      ...
      <div className="w-full fixed bottom-0 bg-gray-900/50 backdrop-blur-xl z-30">
        <div className="mx-auto h-[90px] w-[970px] bg-gray-100/10">
